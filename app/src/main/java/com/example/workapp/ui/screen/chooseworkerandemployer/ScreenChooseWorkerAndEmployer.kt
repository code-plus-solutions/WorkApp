...
@Composable
public fun ScreenChooseWorkerAndEmployer(
    modifier: Modifier = Modifier,
    viewModel: ScreenChooseWorkerAndEmployerViewmodel = hiltViewModel()
) {
    // add view model with hilt
    Box(
        modifier
            .fillMaxSize()
    ) {
        ...
        Column(
            ...
            Button(
                ...
                viewModel.onClickChooseEmployer()
            }
